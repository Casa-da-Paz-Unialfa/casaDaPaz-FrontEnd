    ...
    <footer className={`w-full sticky bottom-0 left-0 z-20 ${styles.footer}`}>
      <div className="max-w-[1240px] mx-auto border-b-2 border-gray-700 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 text-center gap-8">
          <div>
            <h6 className="uppercase text-lg font-bold text-[#171717]">Support</h6>
          ...
          <div>
            <h6 className="uppercase text-lg font-bold text-[#171717]">Sobre Nós</h6>
            <ul className="space-y-2">
          ...
          <div>
            <h6 className="uppercase text-lg font-bold text-[#171717]">Services</h6>
            <ul className="space-y-2">
          ...
          <div>
            <h6 className="uppercase text-lg font-bold text-[#171717]">Redes Sociais</h6>
      ...
      <div className="flex flex-col max-w-[1240px] px-4 py-4 mx-auto text-center text-gray-500">
        <p>© 2025 Faculdade Alfa Umuarama, Alunos: Bruno Cherbaty, Maria Eduarda Guirelli, Rodrigo Alcantara</p>
      </div>
    </footer>
  );
};
